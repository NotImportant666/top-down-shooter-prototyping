...
func _process(delta):
	...
	var extension : Vector2 = extension_direction.normalized() * extension_direction.length() * 0.3 # the actual extenstion is the extention direction + 10% of the length of the direction
